...
# write the file
yaml_path = "/%s/tester_restapi.yaml" % ( Settings.getDirExec())
...
# write the file
yaml_path = "/%s/admin_restapi.yaml" % (Settings.getDirExec())
with open(yaml_path, "wt" ) as f:
    f.write( "\n".join(swagger) )
...
# write the file
yaml_path = "/%s/common_restapi.yaml" % (Settings.getDirExec())
with open(yaml_path, "wt" ) as f:
    f.write( "\n".join(swagger) )
