...
<?php
		...
		if ( $s == $SUB_PAGE_DOCS )
		{
            ...
            $tb .= '<ul>';
            $tb .= '<li class="docslist"><a href="https://extensiveautomation.readthedocs.io/en/latest/" target="_blank">extensiveautomation.readthedocs.io</a></li>';
            $tb .= '</ul>';
            ...
            $tb .= '<ul>';
            $tb .= '<li class="docslist"><a href="./common-api-rest/extensiveautomation.json" target="_blank">swagger.json</a></li>';
            $tb .= '<li class="docslist"><a href="./common-api-rest/extensiveautomation.yaml" target="_blank">swagger.yaml</a></li>';
            $tb .= '</ul>';
            $tb .= '</ul>';
            ...
            $tb .= '<ul>';
            $tb .= '<li class="docslist"><a href="./tester-api-rest/extensiveautomation.json" target="_blank">swagger.json</a></li>';
            $tb .= '<li class="docslist"><a href="./tester-api-rest/extensiveautomation.yaml" target="_blank">swagger.yaml</a></li>';
            $tb .= '</ul>';
            $tb .= '</ul>';
            ...
            $tb .= '<ul>';
            $tb .= '<li class="docslist"><a href="./admin-api-rest/extensiveautomation.json" target="_blank">swagger.json</a></li>';
            $tb .= '<li class="docslist"><a href="./admin-api-rest/extensiveautomation.yaml" target="_blank">swagger.yaml</a></li>';
            $tb .= '</ul>';
            $tb .= '</ul>';
