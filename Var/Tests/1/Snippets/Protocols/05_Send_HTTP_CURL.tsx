...
class SEND_HTTP(TestCase):
	...
	def prepare(self, host):
		self.LIB_JSON = SutLibraries.DataExchange.JSON(parent=self, name=None, debug=input('DEBUG'), ignoreErrors=False, shared=False)
		self.LIB_XML = SutLibraries.DataExchange.XML(parent=self, debug=False, coding='UTF-8', name=None, shared=False)
