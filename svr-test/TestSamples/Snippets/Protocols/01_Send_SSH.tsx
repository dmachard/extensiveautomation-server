	...
	def prepare(self, svr):
		...
		if self.step1.isEnabled():
			...
			if input('ALREADY_SHARED'):
				...
				self.ADP_SYS = SutAdapters.SSH.Terminal(parent=self, destIp=svr["SSH_DEST_HOST"],destPort=int(svr["SSH_DEST_PORT"]),
