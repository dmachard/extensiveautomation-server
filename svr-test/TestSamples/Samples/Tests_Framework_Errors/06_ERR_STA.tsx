...
class ERR_STA_001(TestCase):
	...
	def definition(self):
		...
		state = SutAdapter.State(parent=self, name='a', initial='a')
]]></testdefinition>
<testexecution><![CDATA[
ERR_STA_001(suffix=None).execute()]]></testexecution>
<testdevelopment>1413831888.53</testdevelopment>
</file>