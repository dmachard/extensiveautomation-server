...
class SHA512(TestLibraryLib.Library):
	@doc_public
	def __init__(self, parent, name=None, debug=False, shared=False):
		"""
		This library implements the SHA-2 512 cryptographic hash function.
	...
	def compute (self, data, hexdigit=True):
		"""
		Return the digest of the string data, the result containing  hexadecimal digits (64 octets) or string.
