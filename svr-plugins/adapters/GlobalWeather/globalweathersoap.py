...
__NAME__="""GLOBALWEATHERSOAP"""

class GlobalWeatherSoap(TestAdapter.Adapter):
	def __init__(self, parent, name=None, debug=False, shared=False, agentSupport=False, agent=None, 
				...
				xmlns4='http://www.w3.org/2001/XMLSchema', xmlns5='http://www.w3.org/XML/1998/namespace',
				xmlns6='', destUri='/globalweather.asmx',
