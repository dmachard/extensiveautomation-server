...
__HELPER__ = [
                ...
                ('Interact', ['interact']), 
                ('Private', ['__init__', 'getPath', 'getFile', 'addFolder', 'saveFile', 'appendFile']), 
                ('Public', ['__init__', 'getPath', 'getFile', 'addFolder', 'saveFile', 'appendFile']), 
                ('Step', ['__init__', 'setDisabled', 'setEnabled', 'isEnabled', 'setSummary', 'setDescription', 'setExpected', 'getId', 'start', 'setFailed', 'setPassed']), 
                ('Test', ['terminate', 'interrupt']), 
                ('TestCase', ['__init__', 'getPreviousStep', 'setPurpose', 'setRequirement', 'setName', 'getId', 'addStep', 'findAdapter', 'label', 'condition']), ('Timer', ['sleep', 'sleepUntil', 'wait', 'waitUntil', 'utc', 'local']), 
...
class TestSuitesManager(object):
    ...
    def getHeaderReport(self):
        ...
        """
        return  u"<div class='report_header'>Test report auto-generated by <a href='https://www.extensiveautomation.org/'>Extensive Automation</a> - Copyright (c) 2010-2019 - Denis Machard</div>" 
