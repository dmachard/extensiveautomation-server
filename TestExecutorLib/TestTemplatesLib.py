...
__HELPER__ = [
                ('Template', ['__init__', 'compare', 'getRaw', 'getValue', 'prepareLayer']), 
                ('TemplateLayer', ['__init__', 'addRaw', 'getRaw', 'getName', 'updateName', 'getLenItems', 'getItems', 'getValues', 'getKeys', 'getInt', 'get', 'addKey', 'updateKey', 'removeKey', 'addMore']), 
                ('TemplateMessage', ['__init__', 'addRaw', 'getRaw', 'getInt', 'get', 'addLayer', 'getLayer'])
             ]
try:
