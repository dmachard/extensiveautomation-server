...
__HELPER__ = [
                ...
                ('IPv4Address', ['__init__', 'isValid', 'toList', 'getLocalhost', 'getRandom', 'getNull', 'getBroadcast']), 
                ('IPv6Address', ['__init__', 'isValid']), 
                ('Integer', ['__init__', 'isValid', 'getRandom']), 
                ('MacAddress', ['__init__', 'toList', 'getRandom', 'getNull', 'getBroadcast', 'isValid']), 
                ('String', ['__init__', 'isValid', 'containsDigits', 'containsUpperCase', 'containsLowerCase', 'containsWhitespaces', 'containsPunctuations', 'getRandom']), 
